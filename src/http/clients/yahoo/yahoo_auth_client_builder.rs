...
use crate::http::clients::yahoo::yahoo_client::{YahooAuthClient, YahooAuthRequest, YahooTokenRequest, YahooRefreshTokenResponse, YahooError, YahooRefreshTokenRequest, generate_refresh_token_headers};
...
impl YahooAuthClientBuilder {
    pub fn new() -> YahooAuthClientBuilder {
        YahooAuthClientBuilder {
            ...
            // auth_headers: crate::http::clients::yahoo::yahoo_client::generate_refresh_token_headers(
    ...
    pub async fn get_reqwest_headermap(auth_headers: &HeaderMap) -> axum::http::HeaderMap {
